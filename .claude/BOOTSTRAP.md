...
7. **GA4 / web analytics:** load `.claude/skills/ga4-analytics/SKILL.md` — requires `ga4` MCP + property ID in brand-context
...
| `mcp__ga4__*` | Google Analytics MCP (GA4 — Jinu, read-only) |
